...
export async function ListarUsuariosDB() {
    ...
    let [resultado] = await conexion.query("SELECT usuario.idUsuario,usuario.nombre, usuario.fechaIngreso, usuario.estado, usuario.correo, rol.nombre as nombreRol FROM usuario JOIN rol ON rol.idRol = usuario.idRol");
